...
import { useGetAllStudents } from '../../../../hooks/Admin/useAdminGetAllStudent';
import { useAdminUpdateStudent } from '../../../../hooks/Admin/useAdminUpdateStudent';
...
const AdminManageStudent = () => {
    ...
    const deleteModal = student => {
        setmodalDataCaution(student?._id)
        setShowAlertDialog(true)
    }
    const deletingStudent = () => {

        handleDeleteStudent(modalDataCaution)
    }
                                ...
                                <div className='flex col-span-2 justify-end p-2'>
                                    <div className="flex justify-end ">
                                        <div>
                                            ...
                                            <button className=' bg-red-600 text-white px-3 py-3 rounded-md shadow-md m-1' onClick={()=>deleteModal(user)}>Delete</button>
