...
import { useUpdateAdminDetails } from '../../hooks/Admin/useUpdateAdmin';
...
const AdminProfile = () => {
    ...
    return (
        ...
        <AdminNavbar />
                ...
                <div className=' mt-5 gap-y-5 gap-x-5 mx-5'>
                    <div className="bg-white  mx-[20vw] shadow-lg rounded-md">
                        ...
                        <div className=" basis-1/5 p-2 ">
                                    <div className = "bg-gray-400 rounded-full w-20 h-20 border-2 flex items-center justify-center shadow-lg">
                                        <p className='text-white text-3xl font-bold'>{user?.adminName?.charAt(0)?.toUpperCase()}</p> {/* place it in center  */}
                                    </div>
                                    <br></br>
                                    <div className=' px-4'>                         
                        ...
                        <form onSubmit={handleUpdateDetails} className='basis-4/5' >
                            ...
                            {editProfileState ? <div className = "flex flex-row gap-2 pb-5">
                                ...
                                <div className="basis-1/2 px-3">
                                    <button className="bg-red-600 hover:bg-red-500 mt-4 text-white h-10 w-full rounded-md shadow-md" onClick = {handleEditProfileState}>
                                            Cancel
                                    </button>
                                </div>    
                                <div className="basis-1/2 px-3">
                                    <button type="submit" className="bg-[#11244e] hover:bg-[#060f24] mt-4 text-white h-10 w-full rounded-md shadow-md">
                                            Update Details
                                    </button>
                                </div>
                            </div> : 
                            <div className="flex flex-row px-3 pb-5">
                                ...
                                <button className="bg-[#11244e] hover:bg-[#060f24] mt-4 text-white h-10 w-full rounded-md shadow-md" onClick = {handleEditProfileState}>
                                        Edit Profile
                                </button>
                            </div>
                            }
